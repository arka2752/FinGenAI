  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: cs.surface,
        elevation: 0,
        title: Text('Register', style: Theme.of(context).textTheme.titleLarge?.copyWith(color: cs.onSurface, fontWeight: FontWeight.bold)),
      ),
      body: LayoutBuilder(
                ...
                child: Column(
                  children: [
                    ...
                    _AuthCard(
                      ...
                      subtitle: 'Join and manage finances smarter',
                      child: Column(
                        children: [
                          TextField(
            ...
            Row(
              children: [
                Container(
                  ...
                  child: Icon(Icons.person_add_alt, color: cs.primary, size: isSmall ? 20 : 22),
                ),
